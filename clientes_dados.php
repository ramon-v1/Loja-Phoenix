...
// Verifica se as variáveis abaixo foram declaradas
if (isset($_POST['cli_nome']) and isset($_POST['cli_email']) and isset($_POST['cli_cpf'])) {

    // Variáveis correspondentes a cada campo
    ...
    // Dados que vieram da sessão (não são alteráveis no formulário)
    ...
    if (!$clientes->Editar($_SESSION['CLI']['cli_id'])) {
        ...
        echo '<div class="alert alert-success">Dados atualizados com sucesso! Atualizando dados do login...</div>';
